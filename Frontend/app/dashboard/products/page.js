...
//         <Link href="/dashboard/products/new" className="bg-green-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 font-medium">
...
//               <th className="px-6 py-4 font-semibold text-gray-600">Inventory</th>
//               <th className="px-6 py-4 font-semibold text-gray-600">Price</th>
//               <th className="px-6 py-4 text-right text-gray-600">Actions</th>
//             </tr>
//           </thead>
...
//                   <img src={p.imageUrl} className="w-10 h-10 rounded bg-gray-100 object-cover" />
...
//                   </span>
//                 </td>
//                 <td className="px-6 py-4 text-gray-600">{p.stock} in stock</td>
...
// import API from '@/lib/api-client';
// import Link from 'next/link';
// // Added 'Download' and 'AlertTriangle' icons
...
//     try {
//       // Manually fetching with token to handle Blob response
